...
#define XF86AudioToogleVolume 0x1008ff12
...
// volume
static const char *volumeUp[] = { "amixer", "-c", "1", "set", "Master", "5+" };
static const char *volumeDown[] = { "amixer", "-c", "1", "set", "Master", "5-" };
static const char *volumeMute[] = { "amixer", "-c", "1", "set", "Master", "0" };
...
static const Key keys[] = {
	...
	{ 0, 							XF86AudioToogleVolume, 	spawn, 			{.v = volumeMute} },
